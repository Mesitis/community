...
- Returns chart data for historical allocations
'''
...
get_historical_allocation_data_url = "https://api.canopy.cloud:443/"
...
#enter user ID for specific data
user_ids = ""
...
querystring = {"user_ids":user_ids,"from_date": from_date,"to_date":to_date}
...
response = requests.request("GET", get_historical_allocation_data_url, headers=headers, params=querystring)

...
get_documents_for_a_security_url = "https://api.canopy.cloud:443/api/v1/admin/documents.json"
...
url = "https://api.canopy.cloud:443/api/v1/securities/documents.json"

querystring = {"ticker":"AAPL_US","page":"1","per_page":"20"}

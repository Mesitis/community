...
retrieve_document_signature_url = "https://api.canopy.cloud:443/api/v1/uploads.json"
...
#Change doc_url to url of document
doc_url = ""
...
response = requests.request("POST", retrieve_document_signature_url, data=payload, headers=headers)

...
- Returns allocation matrix data for a given user
'''
...
get_allocation_matrix_data_url = "https://api.canopy.cloud:443/api/v1/charts/matrix.json"
...
querystring = {"date":"03-03-2017","date_type":"traded_on","vertical":"geography","horizontal":"geography"}
...
response = requests.request("GET", get_allocation_matrix_data_url, headers=headers, params=querystring)

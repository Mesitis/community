...
- Creates a comment for a commentable resource
'''
...
post_comment_url = "https://api.canopy.cloud:443/api/v1/comments.json"
...
#replace below with commentable id and content
commentable_id = ""
content = ""

payload = {"commentable_id" : commentable_id, "commentable_type" : "document", "content" : content}
headers = {
    'authorization': token,
    'username': username,
...
response = requests.request("POST", post_comment_url, data=payload, headers=headers)

...
- Get performance summary for a parent account or a combination of child user(s).
...
get_performance_summary_url = "https://api.canopy.cloud:443/api/v1/performance/summary.json"
...
response = requests.request("GET", get_performance_summary_url, headers=headers)

...
- Previews documents for a given {{hash}}
'''
...
preview_documents_url = "https://api.canopy.cloud:443/api/v1/documents/preview/{{hash}}.json"
...
#replace below with desired {{hash}} of the document to preview
hash_no = "{{hash}}"
preview_documents_url = "https://api.canopy.cloud:443/api/v1/documents/preview/" + hash_no + ".json"
...
response = requests.request("GET", preview_documents_url, headers=headers)

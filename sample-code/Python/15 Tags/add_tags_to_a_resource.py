...
add_tags_to_a_resource_url = "https://api.canopy.cloud:443/api/v1/tags.json"
...
response = requests.request("POST", add_tags_to_a_resource_url, data=payload, headers=headers)

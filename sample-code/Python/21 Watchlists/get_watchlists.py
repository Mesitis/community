...
- Return json watchlists based on certain parameters and filters
'''
...
get_watchlists_url = "https://api.canopy.cloud:443/api/v1/watchlists.json"
...
response = requests.request("GET", get_watchlists_url, headers=headers, params=querystring)

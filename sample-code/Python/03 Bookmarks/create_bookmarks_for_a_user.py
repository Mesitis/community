...
- Returns bookmarks for a given user
'''
...
create_bookmarks_for_a_user_url = "https://api.canopy.cloud:443/api/v1/bookmarks.json"
...
#replace below with bookmark details
bookmark_name = ""
user_ids = ""

payload = {"name":bookmark_name, "user_ids":user_ids}
...
response = requests.request("POST", create_bookmarks_for_a_user_url, data=payload, headers=headers)

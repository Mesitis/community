...
upload_document_to_s3_url = "https://api.canopy.cloud:443/api/v1/uploads/create.json"
...
#fill in document details below
attachment = ""
description = ""
document_password = ""
document_user_ids = ""

payload = {"attachment": attachment,"description": description,"password": document_password,"report_type": "Confirmations", "document_user_ids": document_user_ids}
headers = {
    'authorization': token,
    'username': username,
    'content-type': "application/x-www-form-urlencoded",
...
response = requests.request("POST", upload_document_to_s3_url, data=payload, headers=headers)

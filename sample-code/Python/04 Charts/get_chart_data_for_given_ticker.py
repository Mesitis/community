...
get_chart_data_for_given_ticker_url = "https://api.canopy.cloud:443/api/v1/charts/security.json"
...
#change ticker to get data for specific ticker
querystring = {"ticker":"AAPL_US"}
...
response = requests.request("GET", get_chart_data_for_given_ticker_url, headers=headers, params=querystring)

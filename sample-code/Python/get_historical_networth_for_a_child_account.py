...
- Get historical networth and profit for a child account.
- Pls note that you will get an error in case you try this for a parent account
- you have to call each child account seperately and add them up in the
...
get_historical_networth_for_a_child_account_url = "https://api.canopy.cloud:443/api/v1/transactions.json"
...
response = requests.request("GET", get_historical_networth_for_a_child_account_url, headers=headers, params=querystring)

...
- Adds (or updates if already exists) watchlist
'''
...
add_update_watchlist_url = "https://api.canopy.cloud:443/api/v1/watchlists.json"
...
querystring = {"countries":"","industries":"","asset_classes":"","custom_tags":"","keyword":"","page":"1","per_page":"25","sort_column":"ticker","sort_direction":"asc"}

#replace below with watchlist details
security_id = ""
custom_tag = ""
industry = ""
asset_class = ""
...
payload = {"security_id":security_id, "tags[custom_tag]":custom_tag, "tags[industry]":industry, "tags[asset_class]":asset_class, "tags[country]":country}
headers = {
    'authorization': token,
    'username': username,
    'content-type': "application/x-www-form-urlencoded",
...
response = requests.request("POST", add_update_watchlist_url, data=payload, headers=headers, params=querystring)

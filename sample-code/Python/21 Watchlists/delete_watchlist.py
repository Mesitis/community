...
- Deletes a watchlist (unfollows a ticker)
'''
...
delete_watchlist_url = "https://api.canopy.cloud:443/api/v1/watchlists.json"
...
response = requests.request("DELETE", delete_watchlist_url, data=payload, headers=headers, params=querystring)

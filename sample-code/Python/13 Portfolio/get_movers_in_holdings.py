...
- Gets the top 5 and bottom 5 movers in holdings for a given user
'''
...
get_movers_in_holdings_url = "https://api.canopy.cloud:443/api/v1/portfolio/movers.json"
...
querystring = {"from_date":"03-03-2016","to_date":"03-05-2016","sort_column":"value_change","sort_direction":"top_and_bottom","page":"1","per_page":"5"}
...
response = requests.request("GET", get_movers_in_holdings_url, headers=headers, params=querystring)

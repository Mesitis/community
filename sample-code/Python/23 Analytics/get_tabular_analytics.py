...
- Returns tabular analytics report
'''
...
get_tabular_analytics_url = "https://api.canopy.cloud:443/api/v1/analytics.json"
...
querystring = {"asset_class":"Equity","label":"AAPL_US","field":"market_cap","user_ids":"","keyword":"","sort_column":"","sort_direction":"asc","page":"1","per_page":"25"}
...
response = requests.request("GET", get_tabular_analytics_url, headers=headers, params=querystring)

...
- deletes a document with a given doc id
'''
...
delete_document_url = "https://api.canopy.cloud:443/api/v1/documents/{{doc_id}}.json"
...
response = requests.request("DELETE", delete_document_url, headers=headers)

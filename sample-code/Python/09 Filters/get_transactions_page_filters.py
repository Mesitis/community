...
- Returns list of filters to be used with transactions page
'''
...
get_transactions_page_filters_url = "https://api.canopy.cloud:443/api/v1/filters/transactions.json"
...
response = requests.request("GET", get_transactions_page_filters_url, headers=headers)

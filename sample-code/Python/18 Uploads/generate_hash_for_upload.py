...
generate_hash_for_upload_url = "https://api.canopy.cloud:443/api/v1/uploads/generate-hash/{{file_id}}.json"
...
response = requests.request("GET", generate_hash_for_upload_url, headers=headers)

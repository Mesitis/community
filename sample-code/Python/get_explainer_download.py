...
- if the user is a regular customer then get a url for cashflow chart data for this user
- if the user is a partner_admin then get a url for cashflow chart data for the first user from the list of users this partner admin has access to
'''

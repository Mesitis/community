...
get_user_url = "https://api.canopy.cloud:443/api/v1/users/{{switch_user_id}}.json"
...
get_user_url = "https://api.canopy.cloud:443/api/v1/users/" + str(switch_user_id) + ".json"
...
response = requests.request("GET", get_user_url, headers=headers)

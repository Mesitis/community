...
request_help_url = "https://api.canopy.cloud:443/api/v1/two_fa/request_help.json"
...
response = requests.request("GET", request_help_url, headers=headers)

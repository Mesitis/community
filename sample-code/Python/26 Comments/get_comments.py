...
- Returns list of comments related to a resource
'''
...
get_comments_url = "https://api.canopy.cloud:443/api/v1/comments.json"
...
#replace below with commentable id
commentable_id = ""

querystring = {"commentable_id":commentable_id,"commentable_type":"document"}
...
response = requests.request("GET", get_comments_url, headers=headers, params=querystring)

...
- Get historical NAV and profit made data for a parent account. In case you want
  this for a particular child account then please add 'user_ids=198' to the query.
'''
...
get_hist_perf_NAV_for_an_account_url = "https://api.canopy.cloud:443/api/v1/transactions.json"
...
response = requests.request("GET", get_hist_perf_NAV_for_an_account_url, headers=headers, params=querystring)

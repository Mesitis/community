...
- get fixed list of market indicatorss
'''
...
get_securities_portfolio_search_url = "https://api.canopy.cloud:443/api/v1/securities/portfolio_search.json"
...
querystring = {"keyword":keyword, "page":page, "per_page":per_page}
...
response = requests.request("GET", get_securities_portfolio_search_url, headers=headers, params=querystring)

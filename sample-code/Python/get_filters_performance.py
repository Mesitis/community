...
- returns the filters for the performance page
'''
import requests
import json
...
get_filters_performance_url = "https://api.canopy.cloud:443/api/v1/filters/performance.json"
...
response = requests.request("GET", get_filters_performance_url, headers=headers)

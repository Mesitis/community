...
- Gets a list of children of one of the parent accounts of a partner admin
'''
...
get_partner_admin_user_children_url = "https://api.canopy.cloud:443/api/v1/admin/users/{{switch_user_id}}/children.json"
...
get_partner_admin_user_children_url = "https://api.canopy.cloud:443/api/v1/admin/users/"+str(switch_user_id)+"/children.json"
...
response = requests.request("GET", get_partner_admin_user_children_url, headers=headers)

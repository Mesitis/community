...
- get a list of users this partner admin has access to
...
get_partner_admin_users_url = "https://api.canopy.cloud:443/api/v1/admin/users.json"
...
response = requests.request("GET", get_partner_admin_users_url, headers=headers)

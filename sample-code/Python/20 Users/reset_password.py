...
- Resets the old password with new password
'''
...
reset_password_url = "https://api.canopy.cloud:443/api/v1/users/password/reset.json"
...
#replace below with old and new password/s
old_password = ""
new_password = ""
...
response = requests.request("POST", reset_password_url, data=payload, headers=headers)

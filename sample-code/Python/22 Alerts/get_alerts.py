...
- Gets alerts for a given user (switch user)
'''
...
get_alerts_url = "https://api.canopy.cloud:443/api/v1/alerts.json"
...
querystring = {"type":"holdings","page":"1","per_page":"20"}
...
response = requests.request("GET", get_alerts_url, headers=headers, params=querystring)

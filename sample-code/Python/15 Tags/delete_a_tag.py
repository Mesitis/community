...
- Show documents for a security based on a ticker
'''
...
delete_a_tag_url = "https://api.canopy.cloud:443/api/v1/tags.json"
...
#replace below with tag details
resource_id = ""

#resource_type is either "UserAccount" or "Security"
...
payload = {"resource_id": resource_id,"resource_type": resource_type,"tags[custom_tags]": custom_tags,"tags[industry_tag]": industry_tag,"tags[asset_class_tag]": asset_class_tag,"tags[country_tag]": country_tag}
...
response = requests.request("DELETE", delete_a_tag_url, data=payload, headers=headers)

...
- Forgot password - sends recovery info to provided email (if user exists on email)
'''
...
forgot_password_url = "https://api.canopy.cloud:443/api/v1/users/password/forget.json"
...
#replace below with email address
email = ""
...
response = requests.request("POST", forgot_password_url, data=payload, headers=headers)

...
get_recovery_code_url = "https://api.canopy.cloud:443/api/v1/two_fa/email_recovery_code.json"
...
response = requests.request("GET", get_recovery_code_url, headers=headers)

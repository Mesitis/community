...
- returns allocation matrix data
'''
...
get_matrix_results_url = "https://api.canopy.cloud:443/api/v1/matrix_results.json"
...
querystring = {"date":"03-03-2017","date_type":"traded_on","sort_direction":"asc","page":"1","per_page":"20"}
...
response = requests.request("GET", get_matrix_results_url, headers=headers, params=querystring)

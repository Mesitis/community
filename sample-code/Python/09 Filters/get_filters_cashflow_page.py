...
- return a list of filters for cashflow page
'''
...
get_filters_cashflow_page_url = "https://api.canopy.cloud:443/api/v1/filters/cashflows.json"
...
response = requests.request("GET", get_filters_cashflow_page_url, headers=headers, params=querystring)

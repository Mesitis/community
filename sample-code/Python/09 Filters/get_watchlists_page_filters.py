...
- Returns list of filters to be used with watchlists page
'''
...
get_watchlists_page_filters_url = "https://api.canopy.cloud:443/api/v1/filters/watchlists.json"
...
response = requests.request("GET", get_watchlists_page_filters_url, headers=headers)

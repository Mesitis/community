...
delete_bookmark_url = "https://api.canopy.cloud:443/api/v1/bookmarks.json"
...
response = requests.request("DELETE", delete_bookmark_url, data=payload, headers=headers)

...
- Returns a list of documents given certain parameters.
'''
...
get_admin_documents_url = "https://api.canopy.cloud:443/api/v1/admin/documents.json"
...
querystring = {"keyword":"dbs","sort_column":"updated_at","sort_direction":"desc","page":"1","per_page":"20"}
...
response = requests.request("GET", get_admin_documents_url, headers=headers, params=querystring)
